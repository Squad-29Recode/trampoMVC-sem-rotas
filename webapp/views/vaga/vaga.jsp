...
<body>
    <!--Começo Nav bar---->
     ...
     <main>
		<header class="tag">
			<h1 class="container">Vagas cadastradas</h1>
		</header>
				...
				<table class="table table-responsive table-hover">
					...
					<jstl:forEach items="${listaVaga}" var="v">
						<tr>
							...
							<td>
								...
								<div class="d-flex">
										<a href="vaga-edit?id=${v.id_Vaga}" class="btn btn-primary mb-1" >Editar</a>
										<a href="aluno-delete?id=${v.id_Vaga}" onclick="return confirm('Deseja excluir o aluno ${v.data_Vaga}?')"class="btn btn-danger mb-1">Excluir</a>
									</div>
						        </td>
						</tr>
						</jstl:forEach>
