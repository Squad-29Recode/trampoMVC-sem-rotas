...
<body>
    <!--Começo Nav bar---->
     ...
     <main>
		<header class="tag">
			<h1 class="container">Inscrição de Vagas</h1>
		</header>
				...
				<table class="table table-responsive table-hover">
					...
					<jstl:forEach items="${listaInscricao}" var="i">
						<tr>

							<td>${i.id_Inscricao}</td>
							...
							<td>
								...
								<div class="d-flex">
										<a href="inscricao-edit?id=${i.id_Inscricao}" class="btn btn-primary mb-1" >Editar</a>
											
											<a href="inscricao-delete?id=${i.id_Inscricao}" onclick="return confirm('Deseja excluir ${i.data_Inscricao}?')" class="btn btn-danger mb-1">Excluir</a>
