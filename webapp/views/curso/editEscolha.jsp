...
<body>
    <!--Começo Nav bar---->
     ...
     <main>
        <header class="tag">
            <h1 class="container">Atualizar Escolha de Curso</h1>
        </header>

       <div class="container py-3">
            <form action="./escolha-update">
            <input type="hidden" id="id" name="id" class="form-control" value="${escolha.id_Escolha}" />

	            <div class="form-group mb-3">
                        <label for="data_Escolha" class="form-label">
                            Data da Escolha
                        </label>
                        <input type="text" id="data_Escolha" name="data_Escolha" class="form-control" placeholder="Insira a data da escolha" value="${escolha.data_Escolha}" />
                    </div>
                    <div class="form-group mb-3">
                        <label for="nome" class="form-label">
                            Nome do Curso
                        </label>
                        <input type="text" id="nome" name="nome" class="form-control" placeholder=" Insira o nome do curso escolhido" value="${escolha.nome}" />
                    </div>
