				...
				<table class="table table-responsive table-hover">
					<thead class="table-dark">
						...
						<tr>
							...
							<th scope="col">Data de início do curso</th>
					...
					<jstl:forEach items="${listaCurso}" var="c">
						<tr>
							...
							<td>
								...
								<div class="d-flex">
										<a href="aluno-edit?id=${c.id_Curso}" class="btn btn-primary mb-1" >Editar</a>
											
										<a href="aluno-delete?id=${c.id_Curso}" onclick="return confirm('Deseja excluir ${c.data_Curso}?')" class="btn btn-danger mb-1">Excluir</a>
