...
<body>
    <!--Começo Nav bar---->
     ...
     <main>
		<header class="tag">
			<h1 class="container">Escolha de Curso</h1>
		</header>
				...
				<table class="table table-responsive table-hover">
					<thead class="table-dark">
						...
						<tr>
							...
							<th scope="col">Data da escolha</th>
					...
					<jstl:forEach items="${listaEscolha}" var="e">
						<tr>
                            ...
                            <td>${e.id_Curso}</td>
								...
								<td>
										<a href="escolha-edit?id=${e.id_Escolha}" class="btn btn-primary mb-1" >Editar</a>
											
									
										<a href="escolha-delete?id=${e.id_Escolha}" onclick="return confirm('Deseja excluir ${e.data_Escolha}?')" class="btn btn-danger mb-1">Excluir</a>
