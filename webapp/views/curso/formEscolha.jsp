    ...
    <div class="form-container">
      <div class="form-section mb-auto">
         ...
         <div class="form-group mb-3">
					<label for="data_Escolha" class="form-label"> Data de início </label> 
					<select id="data_Escolha" name="data_Escolha" class="form-control">
						<option value="DEFAULT"> Escolha a data</option>
						<jstl:forEach items="${listaData}" var="l">
							<option value="${l.data_Curso}">${l.curso}</option>
						</jstl:forEach>
					</select>
				</div>
				
          <div class="form-group mb-3">
					<label for="nome" class="form-label"> Cursos disponíveis </label> 
					<select id="nome" name="nome" class="form-control">
						<option value="DEFAULT">Nome do Curso</option>
						<jstl:forEach items="${listaCurso}" var="l">
							<option value="${l.id_Curso}">${l.curso}</option>
						</jstl:forEach>
					</select>
				</div>
