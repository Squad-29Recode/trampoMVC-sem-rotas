...
<body>
    ...
    <body>
        ...
        <h5>Escolha um dos nossos eventos da Trampo360°!</h5>
        </div>
    <!-- Formulário -->
    <div class="form-container">
      <div class="form-section mb-auto">
         ...
         <div class="form-group mb-3">
					<label for="data_Aquisicao" class="form-label"> Data da Aquição </label> 
					<select id="data_Aquisicao" name="data_Aquisicao" class="form-control">
						<option value="DEFAULT">Escolha a data do evento</option>
						<jstl:forEach items="${listaEvento}" var="l">
							<option value="${l.data_Evento}">${l.evento}</option>
						</jstl:forEach>
					</select>
				</div>
				
          <div class="form-group mb-3">
					<label for="nome" class="form-label"> Eventos disponíveis </label> 
					<select id="nome" name="nome" class="form-control">
						<option value="DEFAULT">Nome do Evento</option>
						<jstl:forEach items="${listaEvento}" var="l">
