...
<body>
    <!--Começo Nav bar---->
     ...
     <main>
        <header class="tag">
            <h1 class="container">Atualizar Evento</h1>
        </header>

       <div class="container py-3">
            <form action="./evento-update">
            <input type="hidden" id="id_Evento" name="id_Evento" class="form-control" value="${evento.id_Evento}" />
	            ...
	            <div class="form-group mb-3">
                        ...
                        <input type="text" id="data_Evento" name="data_Evento" class="form-control" placeholder="Insira a data do evento" value="${evento.data_Evento}" />
                    </div>
                    <div class="form-group mb-3">
                        <label for="nome" class="form-label">
                           Nome do Evento
                        </label>
                        <input type="text" id="nome" name="nome" class="form-control" placeholder=" Insira o nome do evento" value="${evento.nome}" />
                    </div>
                    
                    <button type="submit" class="btn btn-primary">
                        Enviar
                    </button>
                    <a href="./escolha" class="btn btn-danger" style="margin-left: 10px">
                        Cancelar
                    </a>
