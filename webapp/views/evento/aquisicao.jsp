...
<main>
		<header class="tag">
			<h1 class="container">Aquisição Evento</h1>
		</header>
				...
				<table class="table table-responsive table-hover">
					<thead class="table-dark">
						...
						<tr>
							...
							<th scope="col">Data Aquisicao</th>
					...
					<jstl:forEach items="${listaAquisicao}" var="aq">
						<tr>
							...
							<td>
										...
										<a href="aquisicao-edit?id=${aq.id}" class="btn btn-primary mb-1">Editar</a>
																			
										<a href="aquisicao-delete?id=${aq.id}" onclick="return confirm('Deseja excluir ${aq.nome}?')" class="btn btn-danger mb-1">Excluir</a>
