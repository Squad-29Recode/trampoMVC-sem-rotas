					...
					<jstl:forEach items="${listaAluno}" var="a">
						<tr>
							...
							<td>
										...
										<a href="aluno-edit?id=${a.id_Aluno}" class="btn btn-primary mb-1">Editar</a> 
											
										<a href="aluno-delete?id=${a.id_Aluno}" onclick="return confirm('Deseja excluir ${a.CPF}?')" class="btn btn-danger mb-1">Excluir</a>
